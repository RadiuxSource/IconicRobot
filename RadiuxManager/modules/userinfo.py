...
from RadiuxManager.modules.alive import Radiux
import RadiuxManager.modules.sql.userinfo_sql as sql
...
from RadiuxManager.__main__ import STATS, TOKEN, USER_INFO
from RadiuxManager.modules.disable import DisableAbleCommandHandler
from RadiuxManager.modules.helper_funcs.chat_status import sudo_plus
from RadiuxManager.modules.helper_funcs.extraction import extract_user
from RadiuxManager.modules.sql.global_bans_sql import is_user_gbanned
from RadiuxManager.modules.sql.users_sql import get_user_num_chats
...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID:
        ...
        text += "\n\n➩ ᴛʜɪs ᴜsᴇʀ ɪs ᴀ ᴍᴇᴍʙᴇʀ ᴏғ <b>ɪᴄᴏɴɪᴄ ᴀssᴏᴄɪᴀᴛɪᴏɴ</b>.\n"
        disaster_level_present = True
    ...
    if disaster_level_present:
        text += ' \n➩ [<a href="https://t.me/the_radiux_network/881">ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ᴋɴᴏᴡ ᴡʜᴀᴛ ɪs ᴅɪsᴀsᴛᴇʀ ʟᴇᴠᴇʟs.</a>]'.format(
            bot.username
        )
            ...
            message.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "ʜᴇᴀʟᴛʜ", url=f"https://t.me/The_Radiux_Network/20"
                            ),
                            InlineKeyboardButton(
                                "ᴅɪsᴀsᴛᴇʀ", url="https://t.me/The_Radiux_Network/19"
                            ),
                        ],
                        [
                            InlineKeyboardButton(
