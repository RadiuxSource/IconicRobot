...
@Radiux.on_message(filters.command(["gps"]))
...
#     await message.delete()
    ...
    try:
        ...
        """
        geolocator = Nominatim(user_agent="legend-Radiux")
#         zoom=[0-18]
...
@Radiux.on_message(filters.command(["distance"]))
...
# Radiux.add_handler(MessageHandler(gps))     
# Radiux.add_handler(MessageHandler(distance))
