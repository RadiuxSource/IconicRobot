...
from RadiuxManager.mongo.couples_db import _get_image, get_couple

POLICE = [
    [
        InlineKeyboardButton(
            text="ᴀᴅᴅ ᴍᴇ ʙᴀʙʏ",
            url=f"https://t.me/Iconic_Robot?startgroup=true",
        ),
    ],
]
def dt():
    ...
    try:
     ...
     #  if not is_selected:
         ...
         try:
            ...
            p1 = "RadiuxManager/Love/upic.png"
         try:
            p2 = await app.download_media(photo2.big_file_id, file_name="pfp1.png")
         except Exception:
            p2 = "RadiuxManager/Love/upic.png"
            
         img1 = Image.open(f"{p1}")
         img2 = Image.open(f"{p2}")

         img = Image.open("RadiuxManager/Love/HMMM.jpg")
