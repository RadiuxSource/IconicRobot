...
@Radiux.on_message(filters.command(["short"]))
...
@Radiux.on_message(filters.command(["unshort"]))
...
# Radiux.add_handler(MessageHandler(short_urls))
# Radiux.add_handler(MessageHandler(unshort))
__help__ = """
