...
from RadiuxManager import OWNER_ID, pbot
from RadiuxManager.utils.admins import can_change_info
from RadiuxManager.utils.errors import capture_err
from RadiuxManager.utils.mongo import (
    alpha_to_int,
    get_karma,
    get_karmas,
    int_to_alpha,
...
regex_upvote =r"^(\+|\+\+|\+1|thx|thanx|thanks|🖤|❣️|💝|💖|💕|❤️|💘|cool|good|\👍|baby|Radiux|thank you|gud|thankyou|love|pro)$"
