...
import RadiuxManager.modules.fun_strings as fun_strings
from RadiuxManager import dispatcher,OWNER_ID
...
def slap(update: Update, context: CallbackContext):
    ...
    if user_id == bot.id:
        temp = random.choice(fun_strings.SLAP_Radiux_TEMPLATES)
    ...
    if update.effective_user.id == OWNER_ID:
        temp = "➩ @offtopic_community sᴄʀᴀᴛᴄʜᴇs {user2}"
