...
if ENV:
    ...
    SUPPORT_CHAT = os.environ.get("SUPPORT_CHAT", "offtopic_community")
    ...
    from RadiuxManager.config import Development as Config
...
telethn = TelegramClient("Radiux", API_ID, API_HASH)

pbot = Client("RadiuxManager", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN,in_memory=True)
